...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package eglot
    :ensure t
    ;; :hook (python-base-mode . eglot-ensure)  ;; allow pet to start eglot
    )
#+END_SRC
*** lsp-pyright
...
#+BEGIN_SRC emacs-lisp
  (use-package pet
    ...
    (add-hook 'python-base-mode-hook
  	      ...
  	      (setq-local
  	       lsp-pyright-locate-python python-shell-interpreter
  	      ...
  	      (lsp-deferred)  ;; activate lsp last
  	      )))
#+END_SRC
** Rust
